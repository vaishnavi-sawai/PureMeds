          ...
          <div className="center">
            <div>
              <div>
                ...
                <h2 className="center-heading">Medicine Info</h2>
              ...
              {userData ? <div>
                ...
                <h2 className="center-heading">Suppliers' Info</h2>
                {userData.map((data, id) => {
                  return <div key={id}>
                    <p>{data.name} : <span>{data.isVerified? "Verified" : "Not Verified"}</span></p>
                  </div>
                })}
